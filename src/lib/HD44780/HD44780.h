...
/*
    ...
    Copyright © 2006-2008 Hans-Christoph Steiner. All rights reserved. Copyright
   (c) 2010 Arduino LLC. All right reserved.
...
#define HD_OUTPUT GP_None, GS_Medium, GO_PushPull

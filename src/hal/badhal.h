...
#define PERIPHERAL_DEF(_type_, _name_, _address_)                              \
    static _type_ *const _name_ = (void *) _address_

PERIPHERAL_DEF(USART_t, USART3, 0x40004800);
PERIPHERAL_DEF(ADC_t, ADC1, 0x40022000);
PERIPHERAL_DEF(ADC_t, ADC2, 0x40022100);
PERIPHERAL_DEF(ADC_Common_t, ADC12_Com, 0x40022300);
...
PERIPHERAL_DEF(QSPI_t, QSPI, 0x52005000);
...
PERIPHERAL_DEF(ADC_t, ADC3, 0x58026000);
PERIPHERAL_DEF(ADC_Common_t, ADC3_Com, 0x58026300);
